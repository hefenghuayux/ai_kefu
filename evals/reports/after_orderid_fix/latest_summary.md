...
- memory_002: tool_selection_error - expected tool text2cypher
- general_005: route_error - expected route general-query
...
- memory_003: runtime_error - {code: Neo.ClientError.Statement.SyntaxError} {message: Unexpected end of input: expected CYPHER, EXPLAIN, PROFILE or Query (line 0, column 0 (offset: 1))
""
 ^}
